...
<?php
	if(isset($_GET['xoa'])){
		$id= $_GET['xoa'];
		$sql_xoa = mysqli_query($conn,"DELETE FROM tbl_khachhang WHERE khachhang_id='$id'");
	} 
?>
...
<body>
  ...
  <div class="d-flex" id="wrapper">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class=" mb-2">
                        ...
                        <?php 
                          $sql_select_user = mysqli_query($conn," SELECT * FROM tbl_khachhang ");
                        ?>
                        ...
                        <thead class="thead-light">
                          ...
                          <tbody id="content-table">
                            <tr>
                              <td><?php  echo $row_user['khachhang_name']?></td>
                              <td><?php  echo $row_user['khachhang_number']?></td>
                              <td><?php  echo $row_user['khachhang_diachi']?></td>
                              <td><?php  echo $row_user['khachhang_email']?></td>

                              <td class="row" style="border: none;">
                                <div style="margin: auto;">
                                  <a href='?xoa=<?php echo $row_user['khachhang_id']?>' ><button class="btn btn-success sizeTh1" value="true" id='block' data-placement="top"
                                    title="Block" data-target="#block-user" data-toggle="modal"><i
                                      class="txt-center fas fa-lock"></i></button></a>
                                </div>
                              </td>
                            </tr>
                              <?php 
    ...
    <!-- block -->
    <script src="../js/js_admin/user-confirmed.js"></script>
