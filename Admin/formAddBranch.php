...
<?php   
  if(isset($_POST['themsanpham'])){
    ...
    $sql_insert_category = mysqli_query($conn,"INSERT INTO tbl_category(category_name,category_ma,category_soluong ) VALUES ('$tenthuonghieu','$mathuonghieu','$soluongsanpham') ");
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <div class="container mt-4 ">
          <h2 style="text-align: center;">Thêm Thương Hiệu</h2>
            ...
            <div class="row">
              <div class="col-6 space-top">
                ...
                <div class="input-group mb-2">
                  ...
                  <input type="text"  class="form-control py-4" name='mathuonghieu' value="" placeholder="Nhập Mã Thương Hiệu">
                </div>
              </div>
              <div class="col-6 space-top">
                ...
                <div class="input-group mb-2">
                  ...
                  <input type="text"  class="form-control py-4" name='tenthuonghieu' value="" placeholder="Nhập Tên Thương Hiệu">
                </div>
              </div>
            </div>
			 ...
			 <div class="row">
              <div class="col-6 space-top">
                ...
                <div class="input-group mb-2">
                  ...
                  <input type="text"  class="form-control py-4" name='soluongsanpham' value="" placeholder="Nhập Số Lượng Sản Phẩm" >
                </div>
              </div>
            </div>

            <div class="row" style="margin-top: 60px;">
              <input class="btn btn-danger col-sm-3 row space-top space-bottom " name='themsanpham' type="submit" value="Thêm Thương Hiệu">
            </div>
