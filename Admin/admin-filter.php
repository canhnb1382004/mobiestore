...
<head>
  ...
  <title>Thông tin dữ liệu được lọc</title>
  ...
  <div class="d-flex" id="wrapper">
      ...
      <div class="container-fluid">
        <div class="mb-5 mt-3 ">
          <div class="content">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class=" mb-2">
                        ...
                        <a><button data-target="#add-attribute" data-toggle="modal" data-toggle="tooltip"
                            style="margin-right: 10px;" data-placement="top" title="Thêm thuộc tính"
                        ...
                        <table id="bootstrap-data-table" class="table table-hover">
                          ...
                          <tbody id="content-table">
                            <tr>
                              ...
                              <td>Hệ điều hành</td>
                              <td>Chuỗi</td>
                              <td> <a href='#' data-target="#detail-string" data-toggle="modal" data-toggle="tooltip"
                                  data-placement="top"> Chi tiết <i class="fa fa-external-link-alt"></i></a> </td>
                            ...
                            <tr>
                              ...
                              <td>Số</td>
                              <td> <a href='#' data-target="#detail-number" data-toggle="modal" data-toggle="tooltip"
                                  data-placement="top"> Chi tiết <i class="fa fa-external-link-alt"></i></a> </td>
            ...
            <div class="modal fade " id="detail-string" tabindex="-1" role="dialog"
                    ...
                    <table id="bootstrap-data-table" class="table table-hover ">
                      <thead class="thead-light">
                        <tr>
                          ...
                          <th> <button data-toggle="modal" data-target="#add-string-attribute" data-placement="top"
                              data-toggle="tooltip" data-placement="top" title="Thêm sản phẩm" style="margin:0;"
                              class="btn btn-success btn-add"><i class="fas fa-plus-square"></i></button></th>
            ...
            <div class="modal fade " id="detail-number" tabindex="-1" role="dialog"
              aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered detail-attribute" role="document">
                <div class="modal-content ">
                  <div class="modal-header">
                    ...
                    <table id="bootstrap-data-table" class="table table-hover ">
                      <thead class="thead-light">
                        <tr>
                          ...
                          <th> <button data-toggle="modal" data-target="#add-number-attribute" data-placement="top"
                              data-toggle="tooltip" data-placement="top" title="Thêm sản phẩm" style="margin:0;"
                              class="btn btn-success btn-add"><i class="fas fa-plus-square"></i></button></th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            Từ <input type="number" min=0 value=0 class="input-number"> đến <input type="number" min=0
                              value=5 class="input-number"> </td>
                        ...
                        <tr>
                          ...
                          <td> Từ <input type="number" min=0 value=5 class="input-number"> đến <input type="number"
                              value=6 min=0 class="input-number"> </td>
                        ...
                        <tr>
                          ...
                          <td>Tên 6 INCH</td>
                          <td>Từ <input type="number" min=0 value=6 class="input-number"> đến <input type="number"
                              value=999 min=0 class="input-number"> </td>
            ...
            <!-- Modal -->
            <div class="modal fade" id="add-string-attribute" tabindex="-1" aria-labelledby="exampleModalLabel"
              aria-hidden="true">
            ...
            <div class="modal fade" id="add-number-attribute" tabindex="-1" aria-labelledby="exampleModalLabel"
              aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                  ...
                  <div class="modal-body">
                    ...
                    <input type="text" class="title-attribute" autofocus name="">
                    <h5>Chọn giá trị</h5>
                    Từ <input type="number" min=0 class="input-number"> đến <input type="number" min=0
                      class="input-number">
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>
    ...
    <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Xác nhận xóa thuộc tính</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
